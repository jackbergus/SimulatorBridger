...
public abstract class SimEntity implements Cloneable, Serializable {
	...
	public void schedule(int dest, double delay, int tag, Object data) {
		...
		MainEventManager.send(id, dest, delay, tag, data);
	}
	...
	public void schedule(String dest, double delay, int tag, Object data) {
		schedule(MainEventManager.getEntityId(dest), delay, tag, data);
	}
	...
	public void scheduleNow(String dest, int tag, Object data) {
		schedule(MainEventManager.getEntityId(dest), 0, tag, data);
	}
	...
	public void scheduleFirst(int dest, double delay, int tag, Object data) {
		...
		MainEventManager.sendFirst(id, dest, delay, tag, data);
	}
	...
	public void scheduleFirst(String dest, double delay, int tag, Object data) {
		scheduleFirst(MainEventManager.getEntityId(dest), delay, tag, data);
	}
	...
	public void scheduleFirstNow(String dest, int tag, Object data) {
		scheduleFirst(MainEventManager.getEntityId(dest), 0, tag, data);
	}
	...
	public void pause(double delay) {
		...
		MainEventManager.pause(id, delay);
	}
	...
	public int numEventsWaiting(Predicate p) {
		return MainEventManager.waiting(id, p);
	}
	...
	public int numEventsWaiting() {
		return MainEventManager.waiting(id, MainEventManager.SIM_ANY);
	}
	...
	public SimEvent selectEvent(Predicate p) {
		...
		return MainEventManager.select(id, p);
	}
	...
	public SimEvent cancelEvent(Predicate p) {
		...
		return MainEventManager.cancel(id, p);
	}
	...
	public SimEvent getNextEvent() {
		return getNextEvent(MainEventManager.SIM_ANY);
	}
	...
	protected void send(String entityName, double delay, int cloudSimTag, Object data) {
		send(MainEventManager.getEntityId(entityName), delay, cloudSimTag, data);
	}
	...
	protected void sendNow(String entityName, int cloudSimTag, Object data) {
		send(MainEventManager.getEntityId(entityName), 0, cloudSimTag, data);
	}

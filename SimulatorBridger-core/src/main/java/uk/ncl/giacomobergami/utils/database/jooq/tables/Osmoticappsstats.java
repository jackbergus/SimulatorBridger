...
public class Osmoticappsstats extends TableImpl<OsmoticappsstatsRecord> {
     ...
     */
    public final TableField<OsmoticappsstatsRecord, Double> CLOUDLETPROCESSINGTIMEBYVM = createField(DSL.name("cloudletprocessingtimebyvm"), SQLDataType.DOUBLE.nullable(false), this, "");
     ...
     */
    public final TableField<OsmoticappsstatsRecord, Double> EDGELETPROCESSINGTIMEBYMEL = createField(DSL.name("edgeletprocessingtimebymel"), SQLDataType.DOUBLE.nullable(false), this, "");

...
//	public List<SubOption> getSubOptionListEachHost() {
//		return subOptionListEachHost;
//	}

	public int getNumberofExistingSmallVM() {
		return numberofExistingSmallVM;
	}

	public void setNumberofExistingSmallVM(int numberofExistingSmallVM) {
		this.numberofExistingSmallVM = numberofExistingSmallVM;
	}

	public int getNumberofExistingMediumVM() {
		return numberofExistingMediumVM;
	}

	public void setNumberofExistingMediumVM(int numberofExistingMediumVM) {
		this.numberofExistingMediumVM = numberofExistingMediumVM;
	}

	public int getNumberofExistingLargeVM() {
		return numberofExistingLargeVM;
	}

	public void setNumberofExistingLargeVM(int numberofExistingLargeVM) {
	...
	private int numberofExistingMediumVM;

	private int numberofExistingLargeVM;
	 ...
	 */
	public Host(int id, RamProvisioner ramProvisioner, BwProvisioner bwProvisioner, double storage,
	...
	public void addMigratingInVm(Vm vm) {
		...
		if (!getVmsMigratingIn().contains(vm)) {
			...
			getVmList().add(vm);
			updateVmsProcessing(MainEventManager.clock());
			vm.getHost().updateVmsProcessing(MainEventManager.clock());
		}
	}
